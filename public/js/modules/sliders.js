        ...
        function initSlickSliders() {
            ...
            if ($('.product-thumb-slider-vertical').length) {
                initSlick($('.product-thumb-slider-vertical'), {
                    ...
                    prevArrow: '<button type="button" class="slick-prev" aria-label="Previous"><i class="fa-solid fa-chevron-up"></i></button>',
                    nextArrow: '<button type="button" class="slick-next" aria-label="Next"><i class="fa-solid fa-chevron-down"></i></button>',
