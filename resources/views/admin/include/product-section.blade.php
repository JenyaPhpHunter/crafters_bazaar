        ...
        <div class="row learts-mb-n30">
            <div class="col-lg-6 col-12 learts-mb-30">
                <div class="sale-banner11">
                    <div class="inner">
                        <img src="{{ asset('images/banner/sale/sale-banner11-1.webp') }}" alt="">
                        <div class="content">
                ...
                <div class="countdown2 primary2 justify-content-center learts-mt-50" data-countdown="2024/01/01"></div>
