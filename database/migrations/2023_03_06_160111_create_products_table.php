...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->unsignedInteger('sub_kind_product_id')->nullable()->default(null)->comment("Id підвиду товару");
            ...
            $table->unsignedInteger('price')->nullable()->default(null)->comment("Вартість");
            $table->unsignedInteger('discount')->nullable()->default(null)->comment("Знижка");
            $table->unsignedInteger('stock_balance')->nullable()->default(1)->comment("Залишок на складі");
            $table->unsignedInteger('color_id')->nullable()->comment("Id кольору");
            $table->unsignedInteger('term_creation')->nullable()->default(null)->comment("строк виготовлення");
            $table->unsignedInteger('status_product_id')->comment("Статус товару");
            ...
            $table->unsignedInteger('admin_id')->unsigned()->nullable()->comment("Id затверджуючого товар");
